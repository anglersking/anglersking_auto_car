...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2022-09-22
 @ Function     -> Car_start_object()
***/

Car_start_object::Car_start_object()
{
	...
	nh_private.param<std::string>("usart_port", this->usart_port, "/dev/Car_base"); 
	...
	this->cmd_vel_sub = n.subscribe(smoother_cmd_vel, 100, &Car_start_object::cmd_velCallback, this);
	this->amcl_sub = n.subscribe("/amcl_pose", 100, &Car_start_object::cmd_AmclvelCallback, this);
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2022-09-22
 @ Function     -> Car_start_object::cmd_velCallback(const geometry_msgs::Twist &twist_aux)
***/
void Car_start_object::cmd_velCallback(const geometry_msgs::Twist &twist_aux)
{
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2022-09-22
 @ Function     ->  Car_start_object::cmd_AmclvelCallback(const geometry_msgs::PoseWithCovarianceStampedConstPtr &amclPose)
***/
void Car_start_object::cmd_AmclvelCallback(const geometry_msgs::PoseWithCovarianceStampedConstPtr &Pose)
{
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2022-09-22
 @ Function     -> void Car_start_object::PublisherOdom()
***/
void Car_start_object::PublisherOdom()
{
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2022-09-22
 @ Function     -> bool Car_start_object::ReadFormUart()
 @ return 		-> status
***/
bool Car_start_object::ReadFormUart()
{	
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2019-03-25
 @ Function     -> void Car_start_object::publisherImuSensorRaw()
 @ return 		-> null
***/
void Car_start_object::publisherImuSensorRaw()
{
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2019-03-25
 @ Function     -> void Car_start_object::publisherImuSensor()
 @ return 		-> null
***/
void Car_start_object::publisherImuSensor()
{
...
/***
 ...
 @ Author		-> Wanshan.Pang
 @ Date			-> 2022-09-22
 @ Function     -> bool Car_start_object::ReadAndWriteLoopProcess()
 @ return 		-> status
***/
bool Car_start_object::ReadAndWriteLoopProcess()
{
...
float Car_start_object::invSqrt(float number)
{
	volatile long i;
    volatile float x, y;
...
void Car_start_object::accelerometerOffset(float gx, float gy, float gz)
{
...
void Car_start_object::MahonyAHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az)
{
	float recipNorm;
